...
3.以及一些优化
客户端: 1.增加Demo OneClientFastApi 需要安装Dev
...
2.以及一些功能优化
客户端: 1.OneClient包增加控件TOneFastUpdate 提供升级功能
...
去掉TOneDataSet.DataInfo.isPost;属性 增加TOneDataSet.ActiveDesign设计时打开数据，获取字段
...
{ "apiCode":"TEST",
"apiData":{}, "apiParam":{"FBillID":"1AAE0AFFE4E649E7A5EE8E0899AFB81C"} }
...
FTokenFailCallBack
获取账套信息能力
function OneGetZTList(Var QErrMsg: string): TList;
...
' //文件上传示例 function PostGoodsImg(QFormData: TOneMultipartDecode): TActionResult; //获取文件示例 function OneGetGoodsImg(imgid: string): TActionResult;'
4.以及一些BUG和优化
客户端:
oneuniapp客户端:
1.增加商品编辑,文件上传
...
2023-02-09*
服务端:
1.统一返回值类名称及参数大小写叫法与OneLaz,OneuniApp一至, 如果有需要OneUniapp联系叫兽(FLM)QQ:378464060一年399
